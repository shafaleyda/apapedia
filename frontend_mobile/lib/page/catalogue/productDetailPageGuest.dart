...
class ProductDetailGuestPage extends StatefulWidget {
  const ProductDetailGuestPage({Key? key}) : super(key: key);

  @override
  State<ProductDetailGuestPage> createState() => _ProductDetailGuestState();
}

class _ProductDetailGuestState extends State<ProductDetailGuestPage> {
  dynamic product;
